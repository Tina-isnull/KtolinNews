...
import com.example.lcc.ktolinnews.adapter.PullPicAdapter
...
import com.example.lcc.ktolinnews.network.NewsPicWebData
import com.example.lcc.ktolinnews.network.NewsWebData
import org.jetbrains.anko.doAsync
import org.jetbrains.anko.uiThread

class AwkwardFragment : Fragment() {
    val newsWeb = NewsPicWebData()
    var mData = ArrayList<NewsPicBean>()
    var newsData = ArrayList<NewsPicBean>()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recycler.adapter = PullPicAdapter(this.context!!, mData)
    ...
    fun getdata(page: String, ispull: Boolean) {
        //请求数据
        val path = "https://www.qiushibaike.com/pic/page/" + page + "/"
        doAsync {
